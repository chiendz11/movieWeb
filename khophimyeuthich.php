...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
            ...
            <br>
            <br>
            <h3 class="text-center">Hộp Phim</h3>
            <hr>
            <div class="container-fluid padding ">
              <div class="row padding">
                ...
                <?php 
                    ...
                    INNER JOIN khofilmyeuthich on khofilmyeuthich.idfilm = film.idfilm 
                    INNER JOIN user on khofilmyeuthich.iduser = user.iduser 
                ...
                <div class="col-md-3">
                  ...
                  <form action="" method="post">
                          <button value=<?= $row['idfilm']?> style="right:0px;position:absolute;border:none" type="submit" name="del" class="btn btn-outline-secondary">X</button>
                ...
                ?>
                <div class="col-md-12">
                    <h5 class="text-center">Không có phim yêu thích nào</h5>
                <?php
                }
                ?>
              <!--End card-->
