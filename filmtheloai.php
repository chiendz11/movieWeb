...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
            ...
            <h4 class="text-center"><b><i><?= $row['tentheloai']?></i></b></h4>
            <?php 
                }
              }
            ?> 
            ...
            <?php 
                ...
                $from = ($trang -1 ) * $filmperpage;
                  ...
                  where theloai.idtheloai = $idtheloai
                ...
                <div class="col-md-3">
                  <div class="card">
                  <a href="chitiet.php?id=<?= $row['idfilm']?>& id2= <?= $row['idtheloai']?>" class="hvr-sweep-to-bottom"><img src="<?= $row['hinh'] ?>" title="Click để xem phim" class="card-img-top" style="height:300px ; max-height: 500px; max-width: 80%" alt=" "></a>
                    <div class="card-body">
                        <a href="infor.php?id=<?= $row['idfilm']?>"><h4 class="card-title" ><?= limit_text($row['tenfilm'],3) ?></h4></a>
        ...
        <div class ="text-center">
          <?php
            for($t =1;$t<=$pageNumber;$t++){
              echo "<a href='filmtheloai.php?id=$id & trang=$t' class='phantrang btn btn-outline-secondary'>".$t."</a>";
            }
          ?>
        </div>
    ...
    <br>
    <footer>
      <p class="text-center">Sản phẩm được làm bởi ChienBui</p>
      <div class="container-fluid padding">
