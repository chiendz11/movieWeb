...
<?php
    ...
    if (isset($_POST['add'])){
      header("location:addbinhluan.php");
    }
...
<html lang="en">
    ...
    <body>
        <div id="table-container" class="text-center">
            <h5 class="text-center">QUẢN LÝ BÌNH LUẬN<span STYLE="COLOR:RED">(ADMIN RIGHT ONLY)</span></h5>
            <hr>
            <form method="post">
            ...
            <div class="table-responsive">
              <table class="table table-striped table-dark text-center">
                  ...
                  <tr>
                      ...
                      <th scope="row"><?= $row['phimcomment'] ?></th>
                      <th scope="row"><?= $row['noidung'] ?></th>
                      <th scope="row"><?= $row['time'] ?></th>
                      <td> <a href="deletebinhluan.php?id=<?= $row['idcomment']?>" class="delete">Xóa</a></td>
                      <td> <a href="updatebinhluan.php?id=<?= $row['idcomment']?>" class="update">Sửa</a></td> 
                  </tr>
                  <?php
                          }
                      }
