...
<html lang="en">
    ...
    <body>
        <div id="table-container" class="text-center">
            <h5 class="text-center">QUẢN LÝ NGƯỜI DÙNG<span STYLE="COLOR:RED">(ADMIN RIGHT ONLY)</span></h5>
            <hr>
            <form method="post">
            ...
            <div class="table-responsive">
              <table class="table table-striped table-dark text-center">
                  ...
                  <?php 
                      ...
                      ?>
                  <tr>
                      <th scope="row"><?= $row['tenuser'] ?></th>
                      <th scope="row"><?= $row['username'] ?></th>
                      <th scope="row"><?= md5($row['password']) ?></th>
                      <td> <a href="deleteuser.php?id=<?= $row['iduser']?>" class="delete">Xóa</a></td>
                      <td> <a href="updateuser.php?id=<?= $row['iduser']?>" class="update">Sửa</a></td> 
                  </tr>
                  <?php
                          }
                      }
