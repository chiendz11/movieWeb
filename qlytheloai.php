...
<?php
    ...
    if (isset($_POST['add'])){
      header("location:addtheloai.php");
    }
...
<html lang="en">
    ...
    <body>
        <div id="table-container" class="text-center">
            <h5 class="text-center">QUẢN LÝ THỂ LOẠI<span STYLE="COLOR:RED">(ADMIN RIGHT ONLY)</span></h5>
            <hr>
            <form method="post">
            ...
            <div class="table-responsive">
              <table class="table table-striped table-dark text-center">
                  ...
                  <?php 
                      ...
                      ?>
                  <tr>
                      <th scope="row"><?= $row['tentheloai'] ?></th>
                      <td> <a href="deletetheloai.php?id=<?= $row['idtheloai']?>" class="delete">Xóa</a></td>
                      <td> <a href="updatetheloai.php?id=<?= $row['idtheloai']?>" class="update">Sửa</a></td> 
                  </tr>
                  <?php
                          }
                      }
